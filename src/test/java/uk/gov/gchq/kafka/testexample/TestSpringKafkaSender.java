...
@SpringBootTest
@DirtiesContext
public class TestSpringKafkaSender {

    private static final Logger LOGGER =
            LoggerFactory.getLogger(TestSpringKafkaSender.class);
    ...
    public void testSend() throws InterruptedException {
        ...
        LOGGER.info("sending payload='{}'", greeting);
        sender.send(greeting, SENDER_TOPIC);
        ...
        assertThat(received.value(), equalTo(greeting));
//        // AssertJ Condition to check the key
        assertThat(received.key(), equalTo(null));
    }
}